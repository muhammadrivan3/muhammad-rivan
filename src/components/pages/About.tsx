...
const InteractiveJourney = () => {
  ...
  const journeyData = [
    ...
    },
    {
      ...
      description:
        "Joined professional team, worked on enterprise applications",
      icon: "⚡",
...
const PersonalInfo = () => (
  <motion.div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm rounded-2xl p-8 border border-border/30">
